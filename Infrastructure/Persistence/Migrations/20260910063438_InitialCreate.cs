        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Projects_Departments_CurrentDepartmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProjectAssignments_Users_AssignedUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectTransfers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProjectTransfers_Departments_FromDepartmentId",
                        column: x => x.FromDepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProjectTransfers_Departments_ToDepartmentId",
                        column: x => x.ToDepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProjectTransfers_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectTransfers_Users_TransferredById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectAssignments_AssignedUserId",
                table: "ProjectAssignments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Projects_CurrentDepartmentId",
                table: "Projects",
                column: "CurrentDepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectTransfers_FromDepartmentId",
                table: "ProjectTransfers",
                column: "FromDepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectTransfers_ProjectId",
                table: "ProjectTransfers",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectTransfers_ToDepartmentId",
                table: "ProjectTransfers",
                column: "ToDepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectTransfers_TransferredById",
                table: "ProjectTransfers",
